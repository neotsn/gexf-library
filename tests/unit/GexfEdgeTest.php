...
class GexfEdgeTest extends Unit
{
    ...
    public function testProperties()
    {
        ...
        $this->tester->assertEquals('e-n-bf220428ba1c494935f0cf66680590bd-n-8e65decc3598d3ebebcb735b16acf53f', $this->GexfEdge->getId());
    ...
    protected function _before()
    {
        ...
        $this->GexfEdge = new GexfEdge($this->SourceNode, $this->TargetNode, 2, GexfEdge::TYPE_DIRECTED, null, '2020-03-16', '2020-04-30');
    }
}
