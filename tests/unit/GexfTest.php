...
class GexfTest extends Unit
{
    ...
    public function testAttributes()
    {
        ...
        $edge01 = (new GexfEdge($node0, $node1, 1, $this->Gexf->getDefaultEdgeType(), null))
    ...
    public function testDynamics()
    {
        ...
        $edge02 = (new GexfEdge($node0, $node2, 1, $this->Gexf->getDefaultEdgeType(), null, '2009-03-01', '2009-03-10'))
            ->setType(GexfEdge::TYPE_UNDIRECTED)
            ->addSpell(new GexfSpell('2009-03-01', '2009-03-04'))
            ->addSpell(new GexfSpell('2009-03-06', '2009-03-10'));

        $this->Gexf->addEdge(new GexfEdge($node0, $node1, 1, $this->Gexf->getDefaultEdgeType(), null, '2009-03-01'));
        $this->Gexf->addEdge($edge02);
        $this->Gexf->addEdge(new GexfEdge($node1, $node0, 1, $this->Gexf->getDefaultEdgeType(), null, '2009-03-01'));
        $this->Gexf->addEdge(new GexfEdge($node2, $node1, 1, $this->Gexf->getDefaultEdgeType(), null, null, '2009-03-10'));
        $this->Gexf->addEdge(new GexfEdge($node0, $node3, 1, $this->Gexf->getDefaultEdgeType(), null, '2009-03-01'));
    ...
    public function testSimpleGraph()
    {
        $this->Gexf
            ->setTitle('A hello world! file')
            ->setEdgeType(GexfEdge::TYPE_UNDIRECTED);

        $node0 = (new GexfNode('Hello', 'Hello World'))
            ->setCoordinates(15.783598, 40.109245, 3.4)
            ->setColor(0, 51, 102, 0.9)
            ->setSize(1.5)
            ->setShape(GexfNode::SHAPE_TRIANGLE);
        $node1 = (new GexfNode('World', 'Goodbye Earth'));

        $edge0 = (new GexfEdge($node0, $node1, 1, $this->Gexf->getDefaultEdgeType(), 'Don\'t Panic'))
...
<gexf xmlns="http://www.gexf.net/1.2draft" xmlns:viz="http://www.gexf.net/1.2draft/viz" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.gexf.net/1.2draft http://www.gexf.net/1.2draft/gexf.xsd" version="1.2">
    ...
    <graph defaultedgetype="undirected" mode="static" timeformat="date"><nodes><node id="Hello_World" label="Hello"><viz:color r="0" g="51" b="102" a="0.9"/><viz:position x="15.783598" y="40.109245" z="3.4"/><viz:size value="1.5"/><viz:shape value="triangle"/></node><node id="Goodbye_Earth" label="World"><viz:size value="1"/><viz:shape value="disc"/></node></nodes><edges><edge id="Dont_Panic" source="Hello_World" target="Goodbye_Earth" weight="2" type="undirected"><viz:color r="88" g="126" b="170" a="1"/><viz:thickness value="3.2"/><viz:shape value="dotted"/></edge></edges></graph>
</gexf>';
    }
}
